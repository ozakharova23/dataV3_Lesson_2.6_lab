...
SELECT staff_id, count(staff_id) AS "sales per employee"
FROM sakila.rental
GROUP BY staff_id;
...
-- 6. What is the mean length of the film for each rating type. Round off the average lengths to two decimal place.
